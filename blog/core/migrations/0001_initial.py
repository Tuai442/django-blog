    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.cookingcategory')),
                ('ingredients', models.ManyToManyField(blank=True, null=True, related_name='recipes', to='core.ingredient')),
